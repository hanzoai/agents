# Hanzo Agents Architecture

Hanzo Agents provides a modular platform for orchestrating AI agents. The system is composed of a Go-based control plane, SDKs for client languages, and optional runtime services.
