...
This document provides instructions for working on the Hanzo Agents monorepo locally.
...
- `HANZO_AGENTS_DATABASE_URL` — PostgreSQL connection string.
- `HANZO_AGENTS_JWT_SECRET` — Authentication secret (development only).
