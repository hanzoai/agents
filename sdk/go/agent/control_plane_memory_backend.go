...
// controlPlaneURL should be the control plane base URL (e.g. http://localhost:8080).
func NewControlPlaneMemoryBackend(controlPlaneURL, token, agentNodeID string) *ControlPlaneMemoryBackend {
	base := strings.TrimRight(strings.TrimSpace(controlPlaneURL), "/")
