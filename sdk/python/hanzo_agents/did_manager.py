"""
DID Manager for Hanzo Agents SDK
...
class DIDManager:
    """
    Manages DID operations for Hanzo Agents SDK agents.
    ...
    def __init__(
        self, hanzo_agents_server_url: str, agent_node_id: str, api_key: Optional[str] = None
    ):
        """
    ...
    def register_agent(
        ...
        """
        Register agent with Hanzo Agents Server and obtain DID identity package.
        ...
        try:
            ...
            # Send registration request to Hanzo Agents Server
    ...
    def get_identity_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "hanzo_agents_server_id": self.identity_package.hanzo_agents_server_id,
    ...
    def _parse_identity_package(
        ...
        return DIDIdentityPackage(
            ...
            hanzo_agents_server_id=package_data["hanzo_agents_server_id"],
        )
