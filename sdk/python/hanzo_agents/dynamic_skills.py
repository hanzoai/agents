...
class DynamicMCPSkillManager:
    """
    Dynamic MCP Skill Generator that converts MCP tools into Hanzo Agents skills.

    This class discovers MCP servers, lists their tools, and dynamically
    registers each tool as a Hanzo Agents skill with proper schema generation
    ...
    def __init__(self, agent, dev_mode: bool = False):
        ...
        Args:
            agent: The Hanzo Agents agent instance
    ...
    async def discover_and_register_all_skills(self) -> None:
        """
        Discover and register all MCP tools as Hanzo Agents skills.
        ...
        6. Registers each tool as a Hanzo Agents skill
        """
    ...
    async def _register_mcp_tool_as_skill(
        ...
        """
        Register an MCP tool as a Hanzo Agents skill.
