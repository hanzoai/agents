...
class VCGenerator:
    ...
    def generate_execution_vc(
        ...
        try:
            ...
            response = requests.post(
                f"{self.hanzo_agents_server_url}/v1/execution/vc",
                json=vc_data,
                headers=headers,
                timeout=10,
            )
    ...
    def verify_vc(self, vc_document: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            headers.update(self._get_auth_headers())
            response = requests.post(
                f"{self.hanzo_agents_server_url}/v1/did/verify",
    ...
    def get_workflow_vc_chain(self, workflow_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.hanzo_agents_server_url}/v1/did/workflow/{workflow_id}/vc-chain",
    ...
    def create_workflow_vc(
        ...
        try:
            ...
            headers.update(self._get_auth_headers())
            response = requests.post(
                f"{self.hanzo_agents_server_url}/v1/did/workflow/{workflow_id}/vc",
                json=workflow_data,
                headers=headers,
                timeout=10,
            )
    ...
    def export_vcs(
        ...
        try:
            ...
            response = requests.get(
                f"{self.hanzo_agents_server_url}/v1/did/export/vcs",
                params=params,
                headers=self._get_auth_headers(),
                timeout=30,
            )
