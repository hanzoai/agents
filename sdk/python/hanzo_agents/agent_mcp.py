...
from hanzo_agents.types import AgentStatus, MCPServerHealth
...
class AgentMCP:
    ...
    def _create_and_register_mcp_skill(
        ...
        """
        Create and register a single MCP tool as a Hanzo Agents skill.
        ...
        Args:
            execution_context (ExecutionContext, optional): Hanzo Agents execution context for workflow tracking
    ...
    async def _background_mcp_initialization(self) -> None:
        ...
        try:
            ...
            await self.agent.hanzo_agents_handler.send_enhanced_heartbeat()
