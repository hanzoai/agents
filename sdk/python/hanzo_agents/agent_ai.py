...
from hanzo_agents.logger import log_debug, log_error, log_warn
from hanzo_agents.rate_limiter import StatelessRateLimiter
...
class AgentAI:
    """AI/LLM Integration functionality for Hanzo Agents Agent"""
    ...
    def _fal_provider(self):
        ...
        if self._fal_provider_instance is None:
            from hanzo_agents.media_providers import FalProvider
    ...
    async def _generate_openai_direct_audio(
        ...
        **kwargs,
        ...
        from hanzo_agents.multimodal_response import AudioOutput, MultimodalResponse
