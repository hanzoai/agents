...
class Hanzo AgentsClient:
    ...
    def register_node(self, node_data: Dict[str, Any]) -> Dict[str, Any]:
        """Register agent node with Hanzo Agents server"""
    ...
    async def register_agent(
        ...
        """Register or update agent information with Hanzo Agents server."""
        try:
            ...
            registration_data = {
                ...
                "metadata": {
                    "deployment": {
                        ...
                        "platform": "python",
                        "region": "local",
                        "tags": {"sdk_version": importlib.import_module("hanzo_agents").__version__, "language": "python"},
                    },
    ...
    async def send_enhanced_heartbeat(
        ...
        """
        Send enhanced heartbeat with status and MCP information to Hanzo Agents server.
    ...
    async def notify_graceful_shutdown(self, node_id: str) -> bool:
        """
        Notify Hanzo Agents server that the agent is shutting down gracefully.
