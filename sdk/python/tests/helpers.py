"""Shared testing utilities for Hanzo Agents SDK unit tests."""
...
class StubAgent:
    ...
    hanzo_agents_server: str = "http://hanzo_agents"
    ...
    hanzo_agents_connected: bool = True
...
def create_test_agent(
    ...
    *,
    ...
    FastAPI routing, workflow notifications, and Hanzo Agents registration without
    ...
    class _FakeMemoryClient:
        def __init__(
            self,
            hanzo_agents_client: Any,
            execution_context: Any,
            agent_node_id: Optional[str] = None,
        ):
            self.hanzo_agents_client = hanzo_agents_client
    ...
    class _FakeDIDManager:
        def __init__(self, hanzo_agents_server: str, node: str, api_key: Optional[str] = None):
    ...
    monkeypatch.setattr("hanzo_agents.agent.MCPManager", _FakeMCPManager)
    monkeypatch.setattr("hanzo_agents.agent.MCPClientRegistry", _FakeMCPClientRegistry)
    monkeypatch.setattr(
        "hanzo_agents.agent.DynamicMCPSkillManager", _FakeDynamicSkillManager
    )
    monkeypatch.setattr("hanzo_agents.agent.DIDManager", _FakeDIDManager)
    monkeypatch.setattr("hanzo_agents.agent.VCGenerator", _FakeVCGenerator)
    monkeypatch.setattr(
    ...
    agent = Agent(
        node_id=node_id,
        hanzo_agents_server="http://hanzo_agents",
        version="1.2.3",
