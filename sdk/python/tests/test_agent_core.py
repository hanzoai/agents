...
from hanzo_agents.agent_registry import get_current_agent_instance
...
def make_agent_stub():
    ...
    agent.node_id = "node"
    agent.hanzo_agents_server = "http://hanzo_agents"
...
async def test_note_sends_async_request(monkeypatch):
    ...
    monkeypatch.setattr("hanzo_agents.agent.aiohttp", stub_aiohttp)
