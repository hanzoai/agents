...
from hanzo_agents.decorators import reasoner
...
class TestDecoratorParentChildTracking:
    ...
    async def test_decorated_reasoner_propagates_parent_context(self, monkeypatch):
        ...
        monkeypatch.setattr("hanzo_agents.decorators._send_workflow_start", capture_start)
        monkeypatch.setattr("hanzo_agents.decorators._send_workflow_completion", capture_complete)
