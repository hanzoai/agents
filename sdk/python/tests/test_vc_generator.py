...
def test_generate_execution_vc_success(monkeypatch):
    generator = VCGenerator("http://hanzo_agents")
    ...
    monkeypatch.setattr("hanzo_agents.vc_generator.requests.post", fake_post)
...
def test_get_workflow_vc_chain(monkeypatch):
    ...
    monkeypatch.setattr("hanzo_agents.vc_generator.requests.get", fake_get)
