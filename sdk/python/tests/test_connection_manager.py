...
def mock_agent():
    ...
    agent.hanzo_agents_handler = MagicMock()
    agent.hanzo_agents_handler.send_enhanced_heartbeat = AsyncMock(return_value=True)
...
class TestConnectionManagerStart:
    ...
    async def test_start_success_connects(self, mock_agent, fast_config):
        ...
        assert manager._reconnection_task is None
        assert mock_agent.hanzo_agents_connected is True
    ...
    async def test_start_failure_enters_degraded_mode(self, mock_agent, fast_config):
        ...
        assert mock_agent.hanzo_agents_connected is False
...
class TestHealthCheckLoop:
    ...
    async def test_health_check_sends_heartbeat(self, mock_agent, fast_config):
        ...
        mock_agent.hanzo_agents_handler.send_enhanced_heartbeat = AsyncMock(
            return_value=True
        )
        ...
        assert mock_agent.hanzo_agents_handler.send_enhanced_heartbeat.call_count >= 1
...
class TestErrorHandling:
    ...
    async def test_health_check_error_triggers_reconnection(
        ...
        mock_agent.hanzo_agents_handler.send_enhanced_heartbeat = heartbeat_then_fail
...
class TestIntegration:
    ...
    async def test_connection_reuse_after_health_failure(self, mock_agent, fast_config):
        ...
        mock_agent.hanzo_agents_handler.send_enhanced_heartbeat = varying_heartbeat
