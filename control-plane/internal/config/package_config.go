...
// ConfigurationField represents a single configuration field in hanzo-agents-package.yaml
...
// ConfigurationSchema represents the configuration schema from hanzo-agents-package.yaml
type ConfigurationSchema struct {
	Required []ConfigurationField `yaml:"required" json:"required"`
	Optional []ConfigurationField `yaml:"optional" json:"optional"`
}

// HanzoAgentsPackageConfig represents the structure of hanzo-agents-package.yaml
type HanzoAgentsPackageConfig struct {
...
// LoadHanzoAgentsPackageConfig loads and parses a hanzo-agents-package.yaml file
func LoadHanzoAgentsPackageConfig(packagePath string) (*HanzoAgentsPackageConfig, error) {
	configPath := filepath.Join(packagePath, "hanzo-agents-package.yaml")

	if _, err := os.Stat(configPath); os.IsNotExist(err) {
		return nil, fmt.Errorf("hanzo-agents-package.yaml not found at %s", configPath)
	}
	...
	var config HanzoAgentsPackageConfig
