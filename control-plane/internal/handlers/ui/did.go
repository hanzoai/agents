...
func (h *DIDHandler) GetNodeDIDHandler(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"hanzo_agents_server_id": registry.HanzoAgentsServerID,
...
// GET /v1/ui/executions/:executionId/vc-status
...
// GET /v1/ui/executions/:executionId/vc
...
// POST /v1/ui/executions/:executionId/verify-vc
					...
					"service": []gin.H{
						{
							...
							"type":            "AgentService",
							"serviceEndpoint": fmt.Sprintf("https://hanzo-agents-server/agents/%s", agentDID.AgentNodeID),
						},
					},
				}
						...
						"service": []gin.H{
							{
								...
								"serviceEndpoint": fmt.Sprintf("https://hanzo-agents-server/components/%s", componentDID.ComponentID),
							},
						},
					}
