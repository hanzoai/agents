...
func (m *MockStorageProvider) GetHanzoAgentsServerDID(ctx context.Context, hanzoAgentsServerID string) (*types.HanzoAgentsServerDIDInfo, error) {
	...
	return args.Get(0).(*types.HanzoAgentsServerDIDInfo), args.Error(1)
}

func (m *MockStorageProvider) ListHanzoAgentsServerDIDs(ctx context.Context) ([]*types.HanzoAgentsServerDIDInfo, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func TestGetConfigSchemaHandler(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		// Make request
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/config/schema?packageId=test-package", nil)
	...
	t.Run("Missing AgentId", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents//config/schema?packageId=test-package", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("Missing PackageId", func(t *testing.T) {
		router, _ := setupTestRouter()
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/config/schema", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("Package Not Found", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/config/schema?packageId=nonexistent-package", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestGetConfigHandler(t *testing.T) {
	t.Run("Success - Existing Configuration", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/config?packageId=test-package", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("Missing PackageId", func(t *testing.T) {
		router, _ := setupTestRouter()
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/config", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestSetConfigHandler(t *testing.T) {
	t.Run("Success - Create New Configuration", func(t *testing.T) {
		...
		req, _ := http.NewRequest("POST", "/v1/ui/agents/test-agent/config?packageId=test-package", bytes.NewBuffer(bodyBytes))
	...
	t.Run("Invalid Request Body", func(t *testing.T) {
		router, _ := setupTestRouter()
		req, _ := http.NewRequest("POST", "/v1/ui/agents/test-agent/config?packageId=test-package", bytes.NewBuffer([]byte("invalid json")))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("Missing PackageId", func(t *testing.T) {
		...
		req, _ := http.NewRequest("POST", "/v1/ui/agents/test-agent/config", bytes.NewBuffer(bodyBytes))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
