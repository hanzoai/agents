...
// GET /v1/ui/identity/dids/search?q=greeting&type=all&limit=20&offset=0
...
// GET /v1/ui/identity/agents?limit=10&offset=0
...
// GET /v1/ui/identity/agents/:agent_id/details?limit=20&offset=0
...
// GET /v1/ui/identity/credentials/search?start_time=...&end_time=...&workflow_id=...&status=...&limit=50&offset=0
