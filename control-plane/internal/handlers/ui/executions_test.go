...
func TestListExecutionsHandler(t *testing.T) {
	t.Run("successful_list_executions", func(t *testing.T) {
		...
		// Make request
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/executions", nil)
	...
	t.Run("with_pagination_and_filters", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/executions?page=3&pageSize=5&status=succeeded&workflowId=workflow-1", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("missing_agent_id", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents//executions", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestGetExecutionDetailsHandler(t *testing.T) {
	t.Run("successful_get_execution_details", func(t *testing.T) {
		...
		// Make request
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/executions/123", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("missing_agent_id", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents//executions/123", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("invalid_execution_id_format", func(t *testing.T) {
		...
		req, _ := http.NewRequest("GET", "/v1/ui/agents/test-agent/executions/invalid", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestGetExecutionDetailsHandler_FallbacksToPayloadStore(t *testing.T) {
	...
	router := gin.New()
	router.GET("/v1/ui/agents/:agentId/executions/:executionId", handler.GetExecutionDetailsHandler)

	req, _ := http.NewRequest("GET", "/v1/ui/agents/agent-1/executions/123", nil)
	w := httptest.NewRecorder()
	router.ServeHTTP(w, req)
