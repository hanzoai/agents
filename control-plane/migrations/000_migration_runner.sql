...
-- Description: Complete DID database schema setup for the Hanzo Agents platform
-- Created: 2025-01-08
--
-- This script creates all necessary tables for the DID (Decentralized Identity) implementation
-- in the Hanzo Agents platform, enabling the transition from file-based to database-backed storage.
