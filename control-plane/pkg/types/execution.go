...
var LegacyExecutionEndpoints = struct {
	...
	ExecuteSync:       "/v1/agents/:agent/execute/:target",
	ExecuteAsync:      "/v1/agents/:agent/execute/async/:target",
	ExecuteStatus:     "/v1/agents/:agent/executions/:execution_id",
	ExecuteBatchState: "/v1/agents/:agent/executions/batch-status",
	RunSnapshot:       "/v1/agents/:agent/workflow/runs/:run_id/snapshot",
	ExecutionSnapshot: "/v1/agents/:agent/workflow/executions/:execution_id/snapshot",
	RunEvents:         "/v1/agents/:agent/workflow/runs/:run_id/events",
	ExecutionEvents:   "/v1/agents/:agent/workflow/executions/:execution_id/events",
	RunEventStream:    "/v1/agents/:agent/workflow/runs/:run_id/events/stream",
	ExecutionStream:   "/v1/agents/:agent/workflow/executions/:execution_id/events/stream",
	RunCleanup:        "/v1/agents/:agent/workflows/:workflow_id/cleanup",

	UIWorkflowSummary:        "/v1/ui/workflows/summary",
	UIWorkflowSummaryFast:    "/v1/ui/workflows/summary/optimized",
	UIWorkflowDag:            "/v1/ui/workflows/:workflowId/dag",
	UIWorkflowNotes:          "/v1/ui/workflows/:workflowId/notes/events",
	UIAgentExecutionList:     "/v1/ui/agents/:agentId/executions",
	UIAgentExecutionDetail:   "/v1/ui/agents/:agentId/executions/:executionId",
	UIAgentExecutionTimeline: "/v1/ui/agents/:agentId/executions/:executionId/timeline",

	UIWorkflowRunList:   "/v2/ui/workflow-runs",
	UIWorkflowRunDetail: "/v2/ui/workflow-runs/:run_id",

	UISessionRuns: "/v1/ui/sessions/:session_id/workflows",
}
