...
// CallbackDiscoveryInfo captures how the HanzoAgents server resolved an agent callback URL.
...
type WorkflowExecution struct {
	...
	HanzoAgentsRequestID string  `json:"hanzo_agents_request_id" db:"hanzo_agents_request_id"`
