...
type DIDRegistry struct {
	HanzoAgentsServerID string                  `json:"hanzo_agents_server_id" db:"hanzo_agents_server_id"`
...
type DIDIdentityPackage struct {
	...
	HanzoAgentsServerID string                 `json:"hanzo_agents_server_id"`
}
...
type DIDFilters struct {
	HanzoAgentsServerID *string         `json:"hanzo_agents_server_id,omitempty"`
...
// HanzoAgentsServerDIDInfo represents af server-level DID information stored in the database.
type HanzoAgentsServerDIDInfo struct {
	HanzoAgentsServerID string    `json:"hanzo_agents_server_id" db:"hanzo_agents_server_id"`
	RootDID            string    `json:"root_did" db:"root_did"`
	MasterSeed         []byte    `json:"master_seed" db:"master_seed_encrypted"`
	CreatedAt          time.Time `json:"created_at" db:"created_at"`
