# Hanzo Agents Server Release Scripts

This directory contains automation scripts for building and releasing Hanzo Agents Server binaries to GitHub.
...
curl -sSL https://raw.githubusercontent.com/hanzoai/agents/main/scripts/install.sh | bash

# System-wide install (requires sudo)
curl -sSL https://raw.githubusercontent.com/hanzoai/agents/main/scripts/install.sh | bash -s -- --system

# Custom directory
curl -sSL https://raw.githubusercontent.com/hanzoai/agents/main/scripts/install.sh | bash -s -- --dir ~/bin
```
...
1. **Prepare for release:**
   ```bash
   cd apps/platform/hanzo-agents/scripts
...
- `hanzo-agents-linux-amd64` - Linux Intel/AMD binary
- `hanzo-agents-linux-arm64` - Linux ARM binary
...
### GitHub Repository
The scripts are configured for: `hanzoai/agents`
...
```
apps/platform/hanzo-agents/scripts/
