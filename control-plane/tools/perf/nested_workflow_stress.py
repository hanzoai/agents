#!/usr/bin/env python3
"""Lightweight load generator for Hanzo Agents durable execution flows.
...
DEFAULT_METRIC_KEYS = [
    ...
    "go_goroutines",
    "hanzo_agents_gateway_queue_depth",
    "hanzo_agents_worker_inflight",
]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Hanzo Agents durable execution load tester"
    )
    parser.add_argument(
        "--base-url", default=os.getenv("HANZO_AGENTS_BASE_URL", "http://localhost:8080")
    )
