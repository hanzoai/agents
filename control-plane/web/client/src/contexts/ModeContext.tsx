...
export function ModeProvider({ children }: ModeProviderProps) {
  const [mode, setModeState] = useState<AppMode>(() => {
    ...
    const savedMode = localStorage.getItem("hanzo-agents-app-mode");
  ...
  const setMode = (newMode: AppMode) => {
    ...
    localStorage.setItem("hanzo-agents-app-mode", newMode);
  };
  ...
  useEffect(() => {
    localStorage.setItem("hanzo-agents-app-mode", mode);
  }, [mode]);
