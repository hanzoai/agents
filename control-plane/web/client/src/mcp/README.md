...
```
MCP UI System
├── Components (hanzo-agents/web/client/src/components/mcp/)
...
├── Hooks (hanzo-agents/web/client/src/hooks/)
...
├── Utilities (hanzo-agents/web/client/src/utils/)
│   └── mcpUtils - Formatting, validation, and helper functions
└── Integration (hanzo-agents/web/client/src/mcp/)
...
1. Create component in `hanzo-agents/web/client/src/components/mcp/`
2. Add proper TypeScript types
3. Include accessibility features
4. Add error boundary support
5. Export from `hanzo-agents/web/client/src/components/mcp/index.ts`

### Adding New Hooks

1. Create hook in `hanzo-agents/web/client/src/hooks/`
2. Follow existing patterns for state management
3. Include proper cleanup and error handling
4. Add TypeScript documentation
5. Export from `hanzo-agents/web/client/src/mcp/index.ts`
