        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild tooltip="GitHub">
              <a href="https://github.com/hanzoai/agents" target="_blank" rel="noopener noreferrer">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild tooltip="Support">
              <a href="https://github.com/hanzoai/agents/issues" target="_blank" rel="noopener noreferrer">
