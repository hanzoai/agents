...
node_id to ensure distinct Hanzo Agents registrations when multiple nodes run.
"""
...
def create_agent(
    ...
    **agent_kwargs,
    ...
    agent_kwargs.setdefault(
        "hanzo_agents_server", os.environ.get("HANZO_AGENTS_SERVER", "http://localhost:8080")
    )
