#!/usr/bin/env python3
"""
Seed the local Hanzo Agents SQLite store with realistic deep-research workflows.
...
DEFAULT_DB_PATH = Path("~/.hanzo_agents/data/hanzo_agents.db").expanduser()
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Seed the Hanzo Agents SQLite workflow tables with realistic data.",
...
def insert_workflow(
    ...
    conn.executemany(
        ...
        INSERT INTO workflow_executions (
            workflow_id, execution_id, hanzo_agents_request_id, run_id, session_id,
