...
This example demonstrates how to use **DID (Decentralized Identifiers)** and **Verifiable Credentials (VCs)** in Hanzo Agents to create cryptographically verifiable audit trails for agent executions.
...
cd hanzo-agents/examples/ts-node-examples
...
1. Open Hanzo Agents UI: `http://localhost:8080`
...
```json
{
  "@context": [
    ...
    "https://hanzo-agents.ai/credentials/v1"
  ],
