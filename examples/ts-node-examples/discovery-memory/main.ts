 ...
 *
 * Run with a control plane at HANZO_AGENTS_URL (defaults to http://localhost:8080):
 ...
 */
import { Agent, AgentRouter } from '@hanzo-agents/sdk';
...
async function main() {
  const agent = new Agent({
    ...
    controlPlaneUrl: process.env.HANZO_AGENTS_URL ?? 'http://localhost:8080',
    aiConfig: {
      provider: 'openai',
      model: 'gpt-4o',
