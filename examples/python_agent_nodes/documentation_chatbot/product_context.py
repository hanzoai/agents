...
PRODUCT_CONTEXT = """
## Product Overview
Hanzo Agents is a Kubernetes-style control plane with IAM for building next generation of autonomous software. It provides production infrastructure
...
**Positioning**: Hanzo Agents is infrastructure, not an application framework. While agent frameworks help you build
single AI applications, Hanzo Agents provides the orchestration layer for
...
- "SDK" or "language" or "languages" or "supported" → Look for: Python SDK, Go SDK, TypeScript SDK, npm install @hanzo_agents/sdk, pip install hanzo_agents
"""
