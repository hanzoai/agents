...
async def _clear_namespace_via_api(namespace: str) -> dict:
    ...
    base_url = os.getenv("CONTROL_PLANE_URL") or os.getenv("HANZO_AGENTS_SERVER") or ""
    base_url = base_url.rstrip("/")
    if not base_url:
        raise ValueError("CONTROL_PLANE_URL (or HANZO_AGENTS_SERVER) is required to clear namespace")

    api_key = os.getenv("CONTROL_PLANE_API_KEY") or os.getenv("HANZO_AGENTS_API_KEY")
