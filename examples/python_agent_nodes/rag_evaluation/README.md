...
> **[Full Documentation](https://hanzo-agents.ai/examples/complete-agents/rag-evaluator)** — Detailed architecture diagrams, API examples, and deployment guides.
...
See the [documentation](https://hanzo-agents.dev/examples/complete-agents/rag-evaluator) for detailed diagrams and explanations.
...
|----------|-------------|---------|
| `HANZO_AGENTS_SERVER` | Control plane URL | `http://localhost:8080` |
