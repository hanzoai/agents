...
A lightweight client for the RAG Evaluation Hanzo Agents node.
...
class RAGEvaluator:
    """
    Python SDK client for RAG Evaluation Hanzo Agents node.
    ...
    def __init__(
        ...
        Args:
            hanzo_agents_server: URL of the Hanzo Agents control plane
            timeout: Request timeout in seconds
            agent_id: ID of the RAG evaluation agent node
        """
        self.base_url = hanzo_agents_server.rstrip("/")
