...
Demonstrates:
- Using Hanzo Agents memory vectors without any extra services
...
app = Agent(
    ...
    hanzo_agents_server=os.getenv("HANZO_AGENTS_SERVER", "http://localhost:8080"),
    ai_config=AIConfig(
...
async def ingest_document(
    ...
    """
    Store a document's chunks + embeddings into Hanzo Agents memory vectors.
    """
...
if __name__ == "__main__":
    ...
    print(f"🌐 Control Plane: {app.hanzo_agents_server}")
    print("Skills:")
