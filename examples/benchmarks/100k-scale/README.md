...
|-----------|----------|---------|-------|
| Hanzo Agents Go SDK | Go 1.21+ | latest | Native Go implementation |
| Hanzo Agents TypeScript SDK | Node.js 20+ | latest | Native TS implementation |
| Hanzo Agents Python SDK | Python 3.12+ | latest | FastAPI-based |
...
|-----------|----------|--------------|--------|----------------|-------------|------------|
| Hanzo Agents Go | 100,000 | 17.3 ms | 26.7 MB | 280 B | 1.0 µs | 8.2M req/s |
| Hanzo Agents TS | 100,000 | 13.5 ms | 13.2 MB | 276 B | 0.25 µs | 4.0M req/s |
| Hanzo Agents Python | 1,000 | 57 ms | 7.2 MB | 7.5 KB | 0.21 µs | 6.7M req/s |
...
| Metric | Hanzo Agents Python | LangChain |
|--------|-------------------|-----------|
